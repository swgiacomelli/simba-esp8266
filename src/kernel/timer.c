...
static struct module_t module = {
    .timers = {
        .tick = {.head_p = &module.timers.tick.tail,
                 .tail = {.next_p = NULL, .delta = 0xffffffff}},
        .high_resolution = {.head_p = &module.timers.high_resolution.tail,
                            .tail = {.next_p = NULL, .delta = 0xffffffff}}}};
...
int timer_module_init(void) { return (timer_port_module_init()); }
...
int timer_init(struct timer_t *self_p, const struct time_t *timeout_p,
  ...
  res = timer_port_high_resolution_init(self_p, timeout_p, flags);
